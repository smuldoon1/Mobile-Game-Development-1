...
class Sprite {
    constructor(sprite, width, height, xOffset, yOffset, xStretch, yStretch, animationSpeed, frameCount, loop) {
        ...
        this.xOffset = xOffset; // How much the sprite is offset from the entities rect in the x-axis
        this.yOffset = yOffset; // How much the sprite is offset from the entities rect in the y-axis
